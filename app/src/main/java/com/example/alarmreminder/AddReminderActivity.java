...
public class AddReminderActivity extends AppCompatActivity implements
    ...
    private EditText message;//c
    private String mMessage;//c
    ...
    private static final String KEY_MESSAGE="message_key";//c
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mCurrentReminderUri == null) {
            ...
            setTitle(getString(R.string.editor_activity_title_new_message));
            ...
            setTitle(getString(R.string.editor_activity_title_edit_message));
        ...
        message=(EditText)findViewById(R.id.details);//c
        ...
        // Setup Reminder Message EditText
    ...
    protected void onSaveInstanceState (Bundle outState) {
        ...
        outState.putCharSequence(KEY_MESSAGE,message.getText());//c
        outState.putCharSequence(KEY_TIME, mTime);
        outState.putCharSequence(KEY_DATE, mDate);
        ...
        switch (item.getItemId()) {
            ...
            case R.id.save_reminder:
                ...
                if (mTitleText.getText().toString().length() == 0){
                    mTitleText.setError("Mobile number cannot be blank!");
                }
    ...
    private void showDeleteConfirmationDialog() {
        ...
        // for the postivie and negative buttons on the dialog.
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setMessage(R.string.delete_dialog_number);
...
*/
        Log.d("current",String.valueOf(mCurrentReminderUri));
        ContentValues values = new ContentValues();

        values.put(AlarmReminderContract.AlarmReminderEntry.KEY_NUMBER, mTitle);
        values.put(AlarmReminderContract.AlarmReminderEntry.KEY_MESSAGE,mMessage);
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        ...
        String[] projection = {
                ...
                AlarmReminderContract.AlarmReminderEntry.KEY_NUMBER,
                AlarmReminderContract.AlarmReminderEntry.KEY_MESSAGE,
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            int titleColumnIndex = cursor.getColumnIndex(AlarmReminderContract.AlarmReminderEntry.KEY_NUMBER);
            int messageCoulmnIndex=cursor.getColumnIndex(AlarmReminderContract.AlarmReminderEntry.KEY_MESSAGE);
            ...
            String message1=cursor.getString(messageCoulmnIndex);
